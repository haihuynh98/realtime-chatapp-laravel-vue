<template>
    <div class="card mb-sm-3 mb-md-0 contacts_card">
        <div class="card-header">
            <h3 class="d-flex text-white">Joiner<span class="badge badge-success ml-2">{{ usersOnline.length }}</span></h3>
        ...
        <div class="card-body contacts_body">
            <div class="contacts">
                <li v-for="user in usersOnline" :key="user.id" @click="$emit('selectReceiver', user)">
