<template>
    <div class="row justify-content-center h-100">
        ...
        <div class="col-md-4 chat">
            <ListJoiner :usersOnline="usersOnline"/>
        </div>
    </div>
</template>
<script>
    import ListJoiner from '../components/ListJoiner'
    ...
    export default {
        ...
        created() {
            ...
            if (index > -1) {
                ...
                Echo.join(`room.${this.currentRoom.id}`).here((users) => { // gọi ngay thời điểm ta join vào phòng, trả về tổng số user hiện tại có trong phòng (cả ta)
